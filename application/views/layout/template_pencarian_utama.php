      ...
      <div id="right-menu" class="modal aside" data-body-scroll="false" data-offset="true" data-placement="right" data-fixed="true" data-backdrop="false" tabindex="-1">
                    ...
                    <form method="post">
                        <div class="form-group"> <!--/here teh addclass has-error will appear -->
                			    Expertise sought
                			    <div>
                			      <input type="text" class="form-control" id="skill" name="skill" placeholder="Name of expertise.." autocomplete="off" onkeyup="autokeahlian(this.value);" value="<?=$keahlian?>">
                        ...
                        <div class="center">
													<div class="center">
														...
														<button class="btn btn-primary btn-xs back-to-login-link" type="button">
...
<![endif]-->
    ...
    <script src="<?php echo base_url();?>assets/js/jquery-ui.custom.min.js"></script>
      ...
      var keahlian = $("#skill").val();
      var provinsi = $("#prop").val();
			manageMemberTable = $("#manageMemberTable").DataTable({
        "destroy" : true,
				"ajax": "<?php echo base_url();?>pencarian/php_action/retrieve.php?keahlian="+keahlian+"&genre=<?=$genre?>&provinsi="+provinsi+"&kota=<?=$kota?>&kecamatan=<?=$kecamatan?>&kelurahan=<?=$kelurahan?>",
				"order": [],
				"processing": true,
				"scrollX": true,
				"autoWidth": true,
