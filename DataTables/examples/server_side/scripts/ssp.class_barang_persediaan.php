...
class SSP {
    ...
    static function data_output ( $columns, $data, $isJoin = true )
    {
        $out = array();
     ...
     */
    static function order ( $request, $columns, $isJoin = true )
    {
        $order = '';
     ...
     */
    static function filter ( $request, $columns, &$bindings, $isJoin = true )
    {
        $globalSearch = array();
        $columnSearch = array();
        $dtColumns = self::pluck( $columns, 'dt' );
     ...
     */
    static function pluck ( $a, $prop, $isJoin = true )
    {
        $out = array();
