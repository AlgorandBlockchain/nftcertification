...
function getState(val) {
	$.ajax({
		type: "GET",
		url: "<?php base_url();?>index.php/home/gate_state",
		data: "?country_id=" + val,
...
function getStatex(val) {
	$.ajax({
	type: "POST",
	url: "<?php echo base_url();?>application/view/get_state.php",
	data:'country_id='+val,
	success: function(data){
...
function selctcity()
{
   var state=$('#warga_negara').val();

		$.post('<?php echo base_url();?>index.php/home/state_list/',
		{
		id:state
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				*/
					  ...
					  <div class="modal-dialog">\
					   <div class="modal-content">\
						<div class="modal-header">\
							...
							<h4 class="blue">Change Avatar xixixixii</h4>\
						</div>\
						\
						<div id="messages"></div>\
						<form action="<?php echo base_url();?>upload/php_action/uploadImage.php" method="POST" id="uploadImageForm">\
						 <div class="modal-body">\
							<div class="space-4"></div>\
							<div style="width:75%;margin-left:12%;"><input type="file" name="userImage" id="userImage" /><input type="text" name="user_id" value="<?=$_SESSION['sess_user_id']?>" /></div>\
						 </div>\
						\
				...
				$('.input-mask-phone').mask('(99) 999-999-999999999');
